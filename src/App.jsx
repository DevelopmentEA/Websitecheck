  ...
  return (
    <motion.div
      variants={{
        ...
        enter: { opacity: 1, y: 0, transition: { ...transition, delay: index * 0.05 } }
      }}
    ...
    >
      <div className="h-full bg-white border border-slate-100 p-5 md:p-6 rounded-[2rem] shadow-sm group-hover:shadow-lg transition-all duration-500">
        ...
        <div className="flex items-center text-[10px] font-black uppercase tracking-widest text-[#059669]">
          Start Module <Zap size={12} className="ml-1 fill-current" />
        </div>
      </div>
    </motion.div>
  );
