          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <div className="relative z-10 flex gap-4 mt-8">
                <NavLink to="/normal" className="flex items-center gap-3 px-8 py-4 bg-white text-[#1A365D] rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#C5A059] hover:text-white transition-all shadow-lg">
                  Start Training
                  <ArrowRight size={16} />
                </NavLink>
                <NavLink to="/hard" className="flex items-center gap-3 px-8 py-4 bg-[#1A365D] border border-white/20 text-white rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#152C4E] transition-all">
                  Expert Modus
                </NavLink>
              </div>
            </motion.div>
